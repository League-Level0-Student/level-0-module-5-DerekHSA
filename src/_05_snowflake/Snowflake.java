...
public class Snowflake {
	...
	public static void main(String[] args) {
		...
		// #1. Make a new Robot
 Robot DiegoBrando=new Robot();

		// #2. Set your robot’s position to x=300 and y=300
 DiegoBrando.setX(300);
 DiegoBrando.setY(300);
		// #3. Put the robot's pen down
 DiegoBrando.penDown();

		// #4. Set the robot’s speed to 5
 DiegoBrando.setSpeed(5);
...
if (i%2==0) {
	DiegoBrando.setPenColor(0,0,255);
}else {
	DiegoBrando.setPenColor(255,0,0);
}
